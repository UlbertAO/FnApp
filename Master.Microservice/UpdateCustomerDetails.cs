...
namespace Master.Microservice
{
    ...
    {
        [FunctionName("UpdateCustomerDetails")]
        public static async Task<HttpResponseMessage> Run(
            [HttpTrigger(AuthorizationLevel.Anonymous, "post", Route = "UpdateCustomerDetails")] HttpRequest req,
            ILogger log)
        {
            try
            {
                ...
                Base result = masterBusinessDomain.UpdateCustomerDetails(customerDetails);
